...
public class ManageCategoryTest extends Base {
	...
	@Test(groups = {
			"regression" }, retryAnalyzer = retry.Retry.class, description = " User is able to access Manage Catergory Page")
	...
	public void verifyuserIsAbleToAccessManageCategoryPage() throws IOException {
		...
		managecategorypage.newbutton().category(lists).groupselect().choosefile().clickTopMenu().clickSowHome()
				.saveButton();
